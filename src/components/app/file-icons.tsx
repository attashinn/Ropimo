...
export function PdfIcon({ size = 18, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9 13v4" />
      <path d="M9 13h2a1 1 0 0 0 0-2H9" />
      <path d="M14 15h1a1 1 0 0 0 0-2h-1v4" />
    </svg>
  );
}
...
export function FigmaIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M5 5.5A3.5 3.5 0 0 1 8.5 2H12v7H8.5A3.5 3.5 0 0 1 5 5.5z" fill="#F24E1E" stroke="#EA580C" />
      <path d="M12 2h3.5a3.5 3.5 0 1 1 0 7H12V2z" fill="#FF7262" stroke="#EA580C" />
      <path d="M12 12.5a3.5 3.5 0 1 1 7 0 3.5 3.5 0 1 1-7 0z" fill="#1ABCFE" stroke="#0284C7" />
      <path d="M5 12.5A3.5 3.5 0 0 1 8.5 9H12v7H8.5A3.5 3.5 0 0 1 5 12.5z" fill="#A259FF" stroke="#7C3AED" />
      <path d="M5 19.5A3.5 3.5 0 0 1 8.5 16H12v3.5a3.5 3.5 0 1 1-7 0z" fill="#0ACF83" stroke="#16A34A" />
    </svg>
  );
}

export function ExcelIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M8 13l4 4" />
      <path d="M12 13l-4 4" />
      <path d="M16 13h-2v4h2" />
    </svg>
  );
}

export function WordIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StarIcon({ size = 16, className, filled = false }: IconProps & { filled?: boolean }) {
  return (
    <svg
      ...
      stroke={filled ? "#CA8A04" : "currentColor"}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
      className={className}
